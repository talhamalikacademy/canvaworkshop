    ...
    <section id="creator" className="relative py-20 md:py-28 bg-gray-950 text-white overflow-hidden">
      <div className="container mx-auto px-6 md:px-8 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
          ...
          <div className="order-2 lg:order-1 space-y-8 h-full">
            {/* Instructor Tag */}
            ...
            <div className="space-y-4">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight" style={{ fontFamily: 'Inter, sans-serif' }}>
                <span className="text-red-500">Talha Malik</span>
              </h2>
              <p className="text-lg md:text-xl text-white/80 uppercase tracking-wider font-semibold" style={{ fontFamily: 'Inter, sans-serif' }}>
                Digital Design Expert & Content Creator
              </p>
            </div>

            {/* Biography */}
            <div className="space-y-6 text-gray-300 leading-relaxed" style={{ fontFamily: 'Inter, sans-serif' }}>
            ...
            <div className="space-y-6">
              <h3 className="text-xl md:text-2xl font-bold text-white" style={{ fontFamily: 'Inter, sans-serif' }}>
                Learn More
              </h3>
          ...
          <div className="order-1 lg:order-2 h-full">
            <div className="relative group h-full">
              ...
              <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-gradient-to-br from-purple-500/20 to-blue-600/20 rounded-full blur-xl"></div>
            </div>
          </div>
        </div>
      </div>
