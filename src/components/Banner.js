...
// const Banner = () => {
//   return (
//     <section className="relative h-[130vh] lg:h-[160vh] w-full overflow-hidden text-white flex items-center">
//       {/* Background Image covering whole section */}
//       <div className="absolute inset-0 z-0">
//         <img
//           src="/BannerPic.png"
...
//       {/* Main content container */}
//       <div className="relative top-4 lg:top-6 z-10 w-full max-w-7xl mx-auto px-8 lg:px-16">
//         {/* Text content overlay */}
//         <div className="w-full  lg:w-[50%] space-y-6 lg:space-y-8 text-center lg:text-left">
//           {/* Main heading */}
//           <h1 className="text-4xl md:text-5xl lg:text-7xl xl:text-8xl font-black text-white leading-tight tracking-tight drop-shadow-lg" style={{ fontFamily: 'Poppins, sans-serif' }}>
...
//           {/* Supporting paragraph */}
//           <p className="text-lg md:text-lg lg:text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto lg:mx-0" style={{ fontFamily: 'Inter, sans-serif', lineHeight: '1.5' }}>
//             {/* A complete guide to using Canva AI to create stunning designs, edit videos, and generate content. Canva AI has changed the market, and here we learn how to use it to its full potential. */}
//             Canva recently introduced AI which changed the whole game of graphic designing. This workshop will give you a complete guide to use Canva with latest features for stunning designs, edit videos, and generate content. Here we will start from basics and go to advance level. Canva Membership, Premium Access For Free, Latest Apps and Features, and so much things that we will cover in the following workshop.
//           </p>
